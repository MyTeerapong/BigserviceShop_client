  ...
  const handleDelete = (id) => {
    Swal.fire({
      ...
      if (result.isConfirmed) {
        try {
          await axios.delete(`http://localhost:3000/api/sale/delete/${id}` , getconfig());
  ...
  return (
    <div className="container-fluid">
      <div className='d-flex justify-content-between mb-4'>
        <div>
            <h4 className="mb-4">จัดการข้อมูลการขายสินค้า</h4>
        </div>
        <div>
          <Link to="/insertSale" className="btn btn-primary">+ เพิ่มรายการขายสินค้า</Link>
        </div>
        ...
        {currentItems.length > 0 ? (
            ...
            <tr key={index}>
                ...
                <button
                    ...
                    onClick={() => handleDelete(item.S_id)}
                >
                    ลบ
                </button>
                </td>
